...
export type ProductsByCollectionHandleQueryVariables = StorefrontTypes.Exact<{
  handle: StorefrontTypes.Scalars['String']['input'];
  first: StorefrontTypes.Scalars['Int']['input'];
}>;


export type ProductsByCollectionHandleQuery = { collection?: StorefrontTypes.Maybe<{ products: { nodes: Array<(
...
interface GeneratedQueryTypes {
  ...
  "#graphql\n  query ProductsByCollectionHandle($handle: String!, $first: Int!) {\n    collection(handle: $handle) {\n      products(first: $first) {\n        nodes {\n          id\n          title\n          handle\n          featuredImage {\n            url\n            altText\n          }\n          priceRange {\n            minVariantPrice {\n              amount\n              currencyCode\n            }\n          }\n        }\n      }\n    }\n  }\n": {return: ProductsByCollectionHandleQuery, variables: ProductsByCollectionHandleQueryVariables},
}
