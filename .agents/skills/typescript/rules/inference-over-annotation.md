...
- Default to inferred return types for local functions and module-private helpers. Add an explicit return type only when it creates a deliberate boundary, such as a public library API or a place where you intentionally want to hide implementation details.
